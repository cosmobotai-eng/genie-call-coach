...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  runDiscoveryAnalysis: (meetingId) => ipcRenderer.invoke('runDiscoveryAnalysis', meetingId),
  onDiscoveryUpdate: (callback) => ipcRenderer.on('discovery-update', (_, data) => callback(data)),
});
